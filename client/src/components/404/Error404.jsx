      ...
      >
        ...
        >
            <Box sx={{fontFamily: 'Roboto', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                <Typography sx={{fontSize: 165, fontWeight: 900, marginBottom: '-70px', color:'secondary.light'}}>404</Typography>
            ...
            >
                <Link href="/mrp-home" color={theme.palette.mode === 'light' ? "primary.main" : "primary.light"} sx={{ display:'flex', alignItems:'center', fontSize:16, fontWeight: 700 }}>Return to Home Page</Link>
